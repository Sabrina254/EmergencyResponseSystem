...
switch($type){
    case 'medical':
        ...
        if ($resultrandcheck->num_rows == 0) {
            $sql = "INSERT INTO user_request_paramedics (request_manual, user_request_longitude, user_request_latitude, user_information_id_user_information, user_request_time_stamp,request_details_manual,help_code) VALUES ('no', '$long', '$lat', '$userid', NOW(),NULL ,'$random')";
...
<div style=\"text-align: center;\"><h1 style=\"position: -webkit-sticky; position: sticky; top:0\">Emergency Response</h1><img src=\"image.png\" height=\"250px\" alt=\"Location pin\"></div>
    ...
    <div class=\"row\">
        <div class=\"mx-auto col-lg-6 text-danger\" style=\"margin-top:20px;margin-bottom: 100px\">
...
";
    ...
    case 'fire':
        ...
        $resultrandcheck = $conn->query($randCheck);
        if ($resultrandcheck->num_rows == 0) {
        $sql ="INSERT INTO user_request_fire(request_manual, user_request_longitude, user_request_latitude, user_information_id_user_information, user_request_time_stamp, user_request_fire_status, id_fire_engine_information, fire_e_id_fire_station_information, request_details_manual,help_code) VALUES ('no', '$long', '$lat', '$userid', NOW(), NULL, NULL, NULL, NULL,'$random')";
        if($conn->query($sql)===true){
            echo "
<div class=\"container\" style=\"margin-top:20px\">
<div style=\"text-align: center;\"><h1 style=\"position: -webkit-sticky; position: sticky; top:0\">Emergency Response</h1><img src=\"image.png\" height=\"250px\" alt=\"Location pin\"></div>
...
";
    ...
    case 'natural':
        ...
        $resultrandcheck = $conn->query($randCheck);
        if ($resultrandcheck->num_rows == 0) {
            $sql = "INSERT INTO user_request_rescue(request_manual, user_request_longitude, user_request_latitude, user_information_id_user_information,user_request_time_stamp, user_request_rescue_status, request_details_manual,help_code) VALUES ('no','$long', '$lat','$userid', NOW(), NULL, NULL,'$random')";
            if ($conn->query($sql) === true) {
                echo "
<div class=\"container\" style=\"margin-top:20px\">
<div style=\"text-align: center;\"><h1 style=\"position: -webkit-sticky; position: sticky; top:0\">Emergency Response</h1><img src=\"image.png\" height=\"250px\" alt=\"Location pin\"></div>
