                    ...
                    if(isset($_POST['signup'])){
                        if($conn->connect_error){
                            ...
                            if ($stmt->execute()) {
                                //on success
                                echo '
<div class="alert alert-success"><button data-dismiss="alert" class="close"></button><b>Success!</b> Now all you have to do is log in. <a href="./">Click here to log in.</a></div>';
