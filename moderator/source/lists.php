        ...
        case 'queue':
            ...
            if($result->num_rows>0) {
                ...
                while ($row=$result->fetch_assoc()){
                    ...
                    echo "<tr><td>". $row['user_request_time_stamp']."</td><td>". $row['user_information_id_user_information']."</td><td>".$long."</td><td>".$lat."</td><td>".$type."</td><td>". $row['help_code']."</td><td>".$man."</td><td><a href=\"manual.php?helpcode=". $row['help_code']."\" class=\"btn btn-secondary btn-sm\">Assign</a></td></tr>";
                }
