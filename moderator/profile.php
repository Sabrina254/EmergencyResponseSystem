...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Profile | Emergency Response System</title>
                  ...
                  <div class="row align-items-center">
                      ...
                      <div class="col-lg order-lg-first">
                          <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                              ...
                              <li class="nav-item">
                                  <a href="javascript:void(0)" class="nav-link" data-toggle="dropdown"><i class="fe fe-box"></i>Cases</a>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <form>
                      <div class="row">
                        <div class="col-auto">
                          <span class="avatar avatar-xl" style="background-image: url(demo/faces/male/16.jpg)"></span>
                        </div>
                        <div class="col">
