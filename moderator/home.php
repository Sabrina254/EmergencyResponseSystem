...
<html lang="en" dir="ltr">
  ...
  <body class="" onload="getStatistics()">
    <div class="page">
      <div class="page-main">
  ...
  <script>
      ...
      function getStatistics(){
          document.getElementById("statisticsHere").innerHTML="<center><div class='loader'></div></center>";
          ...
          xmlhttp.open("POST", "source/statistics.php", true);
          xmlhttp.send();
      }
  </script>
  </body>
