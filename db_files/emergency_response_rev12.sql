...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 20, 2019 at 08:24 AM
...
INSERT INTO `paramedics_information` (`id_paramedics_information`, `paramedics_information_ambulance_number`, `paramedics_information_available`, `paramedics_information_longitude`, `paramedics_information_latitude`, `paramedics_information_uname`, `paramedics_information_email`, `paramedics_information_pin`, `status`, `hospital_information_id_hospital_information`, `isonline`) VALUES
(1, NULL, NULL, NULL, NULL, 'sabrina', 'sabrinaomwoyo412@gmail.com', '1111', 'pending', NULL, 'false');
...
INSERT INTO `rescue_team_information` (`id_rescue_team_information`, `rescue_team_information_identifier_number`, `rescue_team_information_uname`, `rescue_team_information_email`, `rescue_team_information_pin`, `rescue_team_informationcol`, `rescue_team_information_longitude`, `rescue_team_information_latitude`, `rescue_team_information_available`, `status`, `rescue_station_information_id_rescue_station_information`, `isonline`) VALUES
(1, NULL, 'james', 'jameslykie@gmail.com', '1111', NULL, NULL, NULL, NULL, 'pending', NULL, 'false');
...
(6, 'Rhonajoy Karwitha Koome', '0706555078', '0000', NULL),
(7, 'James Mwangi', '0743528944', '0000', NULL);
...
(6, '34.604839999999996', '-0.0038455', 5, '2019-03-13 14:14:05', NULL, 7, NULL, 'no', NULL, 'F23166', 'yes', NULL),
(7, NULL, NULL, 5, '2019-03-13 14:29:02', NULL, NULL, NULL, 'yes', 'hey', 'F65098', NULL, NULL),
(8, '34.604645399999995', '-0.0038455999999999994', 6, '2019-03-19 14:18:55', NULL, 7, NULL, 'no', NULL, 'F12304', 'yes', NULL),
(9, '34.604645399999995', '-0.0038455999999999994', 7, '2019-03-19 15:02:22', NULL, NULL, NULL, 'no', NULL, 'F87176', NULL, NULL);
...
INSERT INTO `user_request_paramedics` (`id_user_request`, `user_request_longitude`, `user_request_latitude`, `user_information_id_user_information`, `user_request_time_stamp`, `id_paramedics_information`, `request_manual`, `request_details_manual`, `help_code`, `assigned`, `complete`) VALUES
(8, '34.604796799999995', '-0.0038455', 5, '2019-03-13 14:13:51', 1, 'no', NULL, 'M7458', 'yes', NULL),
(9, NULL, NULL, 5, '2019-03-13 14:21:30', NULL, 'yes', 'hello', 'M94695', NULL, NULL),
(10, NULL, NULL, 5, '2019-03-13 14:29:39', NULL, 'yes', 'Maseno univeristy TB1', 'M69947', NULL, NULL),
(11, NULL, NULL, 5, '2019-03-16 14:26:51', NULL, 'yes', 'Maseno', 'M32090', NULL, NULL);
...
INSERT INTO `user_request_rescue` (`id_user_request`, `user_request_longitude`, `user_request_latitude`, `user_information_id_user_information`, `user_request_time_stamp`, `user_request_rescue_status`, `id_rescue_information`, `request_manual`, `request_details_manual`, `help_code`, `assigned`, `complete`) VALUES
(2, '34.604796799999995', '-0.0038455', 5, '2019-03-13 14:17:03', NULL, 1, 'no', NULL, 'N54708', 'yes', NULL),
(3, NULL, NULL, 5, '2019-03-13 14:24:32', NULL, NULL, 'yes', 'hello', 'N52343', NULL, NULL);
...
--
ALTER TABLE `paramedics_information`
  MODIFY `id_paramedics_information` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `rescue_team_information`
  MODIFY `id_rescue_team_information` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `user_information`
--
ALTER TABLE `user_information`
  MODIFY `id_user_information` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `user_request_fire`
--
ALTER TABLE `user_request_fire`
  MODIFY `id_user_request` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
