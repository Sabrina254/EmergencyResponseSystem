...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 20, 2019 at 09:52 AM
...
(3, 'Admin', '0700000000', 'admin@ers.co.ke', 'admin', '0000', 3, 3);
...
--
ALTER TABLE `emergency_categories`
  MODIFY `id_emergency_categories` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `level_assignment`
  MODIFY `id_level_assignment` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `moderator_information`
--
ALTER TABLE `moderator_information`
  MODIFY `id_Moderator_information` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
